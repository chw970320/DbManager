<script lang="ts">
	...
	// 매핑 관련 상태
	const currentType: DbDesignDefinitionType = 'database';
	const mappingEndpoint = '/api/database/files/mapping';
...
{#if isOpen}
	<div
		...
		role="dialog"
		aria-modal="true"
		aria-labelledby="database-file-manager-title"
		tabindex="-1"
	>
		<div class="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-white shadow-2xl">
			...
			<div class="sticky top-0 z-10 border-b border-gray-200 bg-white px-6 py-4">
				<div class="flex items-center justify-between">
					<div>
						<h2 id="database-file-manager-title" class="text-xl font-bold text-gray-900">
							데이터베이스 정의서 파일 관리
						</h2>
