<script lang="ts">
	...
	const icons: Record<string, IconDef> = {
		...
		'chart-bar': {
			paths: ['M5 20V10m7 10V4m7 16v-7M3 20h18']
		},
		'message-circle': {
			paths: [
				'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.77 9.77 0 01-4-.84L3 20l.9-3.6A7.37 7.37 0 013 12c0-4.418 4.03-8 9-8s9 3.582 9 8z'
			]
		},
		window: {
			paths: ['M4 5a2 2 0 012-2h12a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V5z', 'M4 8h16']
		},
		'panel-left': {
			paths: ['M4 5a2 2 0 012-2h12a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V5z', 'M9 3v18']
		},
		send: {
